...
type User struct {
	...
	SecondLastName string    `gorm:"size:255;not null" json:"second_last_name"`
	BirthDate      time.Time `gorm:"not null" json:"birth_date"`
	IsDriver       bool      `gorm:"not null" json:"is_driver"`
	Email          string    `gorm:"size:100;not null;unique" json:"email"`
	Password       string    `gorm:"size:100;not null" json:"password"`
	PhoneNumber    string    `gorm:"not null" json:"phone_number"`
	Rol            string    `gorm:"type:text;default:'user'" json:"rol"`
...
func (u *User) Prepare() {
	...
	u.SecondLastName = html.EscapeString(strings.TrimSpace(u.SecondLastName))
